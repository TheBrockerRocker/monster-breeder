...
public class GrowthRecipeCategory implements DisplayCategory<GrowthRecipeCategory.Display> {
	public static final CategoryIdentifier<Display> CATEGORY_IDENTIFIER = CategoryIdentifier.of(MonsterBreeder.MOD_ID, "growth");
	...
	public Renderer getIcon() {
		return EntryStacks.of(ModBlocks.GROWTH_CHAMBER);
	}
	...
	public List<Widget> setupDisplay(Display display, Rectangle bounds) {
		...
		widgets.add(Widgets.createSlot(new Point(startPoint.x + 15, startPoint.y + 34))
	...
	public static class Display extends BasicDisplay {
		public Display(RecipeEntry<GrowthRecipe> recipeEntry) {
			super(
					Collections.singletonList(
							EntryIngredients.of(DnaSampleItem.createItemStack(recipeEntry.value().inputItem()))
					),
					Collections.singletonList(
		...
		public CategoryIdentifier<?> getCategoryIdentifier() {
			return GrowthRecipeCategory.CATEGORY_IDENTIFIER;
		}
	}
}
