...
public class VanillaDna {
	public static final Identifier ALLAY = Identifier.ofVanilla("allay");
	...
	public static final Identifier ENDER_DRAGON = Identifier.ofVanilla("ender_dragon");
	...
	public static final Identifier WITHER = Identifier.ofVanilla("wither");
	...
	public static final Identifier ZOMBIE_HORSE = Identifier.ofVanilla("zombie_horse");
	...
	public static void registerVanillaDna() {
		 ...
		 */
		DnaBuilder
				.create(EntityType.ALLAY.getTranslationKey())
				.setRarity(Rarity.RARE)
				.addSourceMobAsSummonResult(EntityType.ALLAY)
				.buildAndRegister(ALLAY);
		DnaBuilder
		...
		DnaBuilder
				.create(EntityType.ENDER_DRAGON.getTranslationKey())
				.setRarity(Rarity.EPIC)
				.addSourceMob(EntityType.ENDER_DRAGON)
				.buildAndRegister(ENDER_DRAGON);
		DnaBuilder
		...
		DnaBuilder
				.create(EntityType.WITHER.getTranslationKey())
				.setRarity(Rarity.EPIC)
				.addSourceMob(EntityType.WITHER)
				.buildAndRegister(WITHER);
		DnaBuilder
		...
		DnaBuilder
				.create(EntityType.ZOMBIE_HORSE.getTranslationKey())
				.setRarity(Rarity.EPIC)
				.addSourceMobAsSummonResult(EntityType.ZOMBIE_HORSE)
				.buildAndRegister(ZOMBIE_HORSE);
		DnaBuilder
